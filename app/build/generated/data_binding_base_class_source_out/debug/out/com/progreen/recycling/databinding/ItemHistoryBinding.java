...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView historyPoints;

  @NonNull
  public final TextView historyTitle;

  private ItemHistoryBinding(@NonNull MaterialCardView rootView, @NonNull TextView historyDate,
      @NonNull TextView historyPoints, @NonNull TextView historyTitle) {
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.historyPoints;
      TextView historyPoints = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemHistoryBinding((MaterialCardView) rootView, historyDate, historyPoints,
          historyTitle);
    }
